...
class Itech_Doc_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Itech_Doc_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Itech_Doc_Loader will then create the relationship
		...
		wp_enqueue_style( 'itech-doc-public', plugin_dir_url( __FILE__ ) . 'css/itech-doc-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'itech-doc-public', plugin_dir_url( __FILE__ ) . 'js/itech-doc-public.js', array( 'jquery' ), $this->version, false );
